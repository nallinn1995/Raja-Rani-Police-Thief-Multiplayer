...
const RULE_STEPS = [
  {
    ...
    description: 'Before the Thief loot phase begins, Mantri secretly selects 1 kingdom member (Raja, Rani, or Police) to protect.',
  ...
  },
  {
    ...
    detail: 'Looted points are accumulated into the Thief’s temporary loot vault (up to 400 pts). Kingdom members lose 100 points unless shielded by Mantri!',
  ...
  },
  {
    ...
    description: 'Raja and Rani have 25 seconds during the Royal Phase to secretly identify each other across the 5-player table.',
